return {
  ...
  keys = {
    { "gb", function() require("decipher").encode_selection("base64") end, mode = "v", desc = "base64 encode" },
    { "ga", function() require("decipher").decode_selection("base64") end, mode = "v", desc = "base64 decode" },
  }
}
