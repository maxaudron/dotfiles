...
run_once({ "unclutter -root", "redshift", "firefox" }) -- entries must be comma-separated
-- }}}
...
beautiful.taglist_font = "Inconsolata Nerd Font 12" 
...
globalkeys = my_table.join(
    ...
    -- X screen locker
    awful.key({ modkey }, "l", function () os.execute("/home/audron/dotfiles/scripts/i3lock.sh") end,
