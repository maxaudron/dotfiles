...
run_once({ "unclutter -root", "/home/mmnanz/.screenlayout/default.sh", "rocketchat-desktop","firefox", "redshift -l 50.112:8.714 -t 5200:2300",  }) -- entries must be separated by commas
...
local scrlocker    = "/home/mmnanz/dotfiles/scripts/i3lock.sh"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, modkey, altkey }, "p", function() os.execute("screenshot") end,
    ...
    awful.key({ modkey, altkey,  }, "Tab", function () awful.screen.focus_relative( 1) end,
...
awful.rules.rules = {
    ...
    { rule = { class = "st -e /bin/zsh -c weechat" },
